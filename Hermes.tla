...
nodeFailure == 
    /\ aliveNodes' = aliveNodes \ {CHOOSE k \in aliveNodes: \A m \in aliveNodes: k <= m}
...
HNext == 
    \/ \E n \in NODES:       
            \/ HFollowerActions(n)
            \/ HCoordinatorActions(n)
    \/ nodeFailure \* this is for failures
=============================================================================
\* Modification History
\* Last modified Fri Jul 13 16:09:35 BST 2018 by akatsarakis
