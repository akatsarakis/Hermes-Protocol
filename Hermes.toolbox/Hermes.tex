...
\@x{\@s{59.62} issuedWriteTS ,\,}%
\@x{\@s{59.62} aliveNodes ,\,}%
\@x{\@s{59.62} receivedAcks}%
\@pvspace{8.0pt}%
\@x{}%
\@y{\@s{0}%
...
\@x{\@s{16.4} \.{\land}\@s{17.17} aliveNodes\@s{16.40} \.{\subseteq} NODES}%
 \@x{\@s{16.4} \.{\land} \A\, n \.{\in} NODES \.{:} receivedAcks [ n ]
 \.{\subseteq} ( NODES \.{\,\backslash\,} \{ n \} )}%
 \@x{\@s{16.4} \.{\land}\@s{4.1} nodeLastWriter \.{\in} [ NODES\@s{0.37}
 \.{\rightarrow} NODES ]}%
 \@x{\@s{16.4} \.{\land}\@s{4.09} issuedWriteTS\@s{4.1} \.{\in} [ NODES
 \.{\rightarrow} [ version\@s{13.35} \.{:} 0 \.{\dotdot} MAX\_VERSION ,\,}%
\@x{\@s{171.38} tieBreaker \.{:} NODES\@s{32.8} ] ]}%
 \@x{\@s{16.4} \.{\land}\@s{4.09} nodeTS\@s{34.79} \.{\in} [ NODES\@s{0.37}
 \.{\rightarrow} [ version\@s{13.35} \.{:} 0 \.{\dotdot} MAX\_VERSION ,\,}%
\@x{\@s{171.38} tieBreaker \.{:} NODES\@s{32.8} ] ]}%
 \@x{\@s{16.4} \.{\land}\@s{4.09} nodeState\@s{26.04} \.{\in} [ NODES\@s{0.37}
 \.{\rightarrow} \{\@w{valid} ,\,\@w{invalid} ,\,\@w{invalid\_write} ,\,}%
\@x{\@s{173.61}\@w{write} ,\,\@w{replay} \} ]}%
\@pvspace{8.0pt}%
\@x{ HInit \.{\defeq}}%
\@y{\@s{0}%
...
\@xx{}%
\@x{\@s{16.4} \.{\land}\@s{4.1} msgs\@s{51.02} \.{=} \{ \}}%
\@x{\@s{16.4} \.{\land}\@s{4.09} aliveNodes\@s{26.21} \.{=} NODES}%
 \@x{\@s{16.4} \.{\land}\@s{4.09} receivedAcks\@s{18.42} \.{=} [ n \.{\in}
 NODES \.{\mapsto} \{ \} ]}%
 \@x{\@s{16.4} \.{\land}\@s{4.09} nodeState\@s{30.14} \.{=} [ n \.{\in} NODES
 \.{\mapsto}\@w{valid} ]}%
 \@x{\@s{16.4} \.{\land}\@s{4.09} nodeLastWriter\@s{4.1} \.{=} [ n \.{\in}
 NODES \.{\mapsto} {\CHOOSE} k \.{\in} NODES \.{:}}%
\@x{\@s{192.05} \A\, m \.{\in} NODES \.{:} k \.{\leq} m ]}%
 \@x{\@s{16.4} \.{\land}\@s{4.09} nodeTS\@s{38.89} \.{=} [ n \.{\in} NODES
 \.{\mapsto} [ version \.{\mapsto} 0 ,\,}%
\@x{\@s{194.83} tieBreaker \.{\mapsto}}%
\@x{\@s{198.93} {\CHOOSE} k \.{\in} NODES \.{:}}%
\@x{\@s{203.03} \A\, m \.{\in} NODES \.{:} k \.{\leq} m ] ]}%
 \@x{\@s{16.4} \.{\land}\@s{4.09} issuedWriteTS\@s{12.29} \.{=} [ n \.{\in}
 NODES \.{\mapsto} [ version \.{\mapsto} 0 ,\,}%
\@x{\@s{199.31} tieBreaker \.{\mapsto}}%
\@x{\@s{203.41} {\CHOOSE} k \.{\in} NODES \.{:}}%
\@x{\@s{207.51} \A\, m \.{\in} NODES \.{:} k \.{\leq} m ] ]}%
\@x{}\midbar\@xx{}%
\@x{ send ( m ) \.{\defeq} msgs \.{'} \.{=} msgs \.{\cup} \{ m \}}%
\@pvspace{8.0pt}%
 \@x{ receivedAllAcks ( n ) \.{\defeq} receivedAcks [ n ] \.{=} NODES
 \.{\,\backslash\,} \{ n \}}%
\@pvspace{8.0pt}%
\@x{ equalTS ( v1 ,\, tb1 ,\, v2 ,\, tb2 ) \.{\defeq}}%
...
\@x{ nodeFailure \.{\defeq}}%
 ...
 \{ {\CHOOSE} k \.{\in} aliveNodes \.{:} \A\, m \.{\in} aliveNodes \.{:} k
 \.{\leq} m \}}%
 \@x{\@s{16.4} \.{\land} {\UNCHANGED} {\langle} msgs ,\, nodeState ,\, nodeTS
 ,\, nodeLastWriter ,\, issuedWriteTS ,\, receivedAcks {\rangle}}%
\@x{}\midbar\@xx{}%
\@x{ HRead ( n ) \.{\defeq}}%
\@x{\@s{16.4} \.{\land} nodeState [ n ] \.{=}\@w{valid}}%
 \@x{\@s{16.4} \.{\land} {\UNCHANGED} {\langle} msgs ,\, nodeTS ,\, nodeState
 ,\, nodeLastWriter ,\,}%
\@x{\@s{89.98} aliveNodes ,\, issuedWriteTS ,\, receivedAcks {\rangle}}%
\@pvspace{8.0pt}%
\@x{ HWrite ( n ) \.{\defeq}}%
 \@x{\@s{16.4} \.{\land}\@s{4.1} nodeState [ n ]\@s{26.09} \.{\in}
 \{\@w{valid} \}}%
\@x{\@s{16.4} \.{\land}\@s{4.09} nodeTS [ n ] . version \.{<} MAX\_VERSION}%
 \@x{\@s{16.4} \.{\land}\@s{4.09} receivedAcks \.{'}\@s{23.51} \.{=} [
 receivedAcks\@s{8.2} {\EXCEPT} {\bang} [ n ]\@s{6.12} \.{=} \{ \} ]}%
 \@x{\@s{16.4} \.{\land}\@s{4.09} nodeLastWriter \.{'}\@s{9.19} \.{=} [
 nodeLastWriter {\EXCEPT} {\bang} [ n ] \.{=} n ]}%
 \@x{\@s{16.4} \.{\land}\@s{4.09} nodeState \.{'}\@s{35.23} \.{=} [
 nodeState\@s{20.5} {\EXCEPT} {\bang} [ n ]\@s{5.54} \.{=}\@w{write} ]}%
 \@x{\@s{16.4} \.{\land}\@s{4.09} nodeTS \.{'}\@s{43.98} \.{=} [
 nodeTS\@s{32.8} {\EXCEPT} {\bang} [ n ] . version\@s{12.29} \.{=}}%
\@x{\@s{256.44} nodeTS [ n ] . version \.{+} 1 ,\,}%
\@x{\@s{237.15} {\bang} [ n ] . tieBreaker \.{=} n ]}%
 \@x{\@s{16.4} \.{\land}\@s{4.09} issuedWriteTS \.{'}\@s{12.91} \.{=} [
 issuedWriteTS\@s{4.1} {\EXCEPT} {\bang} [ n ] . version\@s{10.98} \.{=}}%
\@x{\@s{258.81} nodeTS [ n ] . version \.{+} 1 ,\,}%
\@x{\@s{239.52} {\bang} [ n ] . tieBreaker \.{=} n ]}%
...
\@x{\@s{16.4} \.{\land}\@s{4.09} {\lnot} isAlive ( nodeLastWriter [ n ] )}%
 \@x{\@s{16.4} \.{\land}\@s{4.09} nodeLastWriter \.{'}\@s{4.1} \.{=} [
 nodeLastWriter {\EXCEPT} {\bang} [ n ]\@s{0.37} \.{=} n ]}%
 \@x{\@s{16.4} \.{\land}\@s{4.09} nodeState \.{'}\@s{30.51} \.{=} [
 nodeState\@s{20.5} {\EXCEPT} {\bang} [ n ]\@s{5.54} \.{=}\@w{replay} ]}%
 \@x{\@s{16.4} \.{\land}\@s{4.09} receivedAcks \.{'}\@s{18.79} \.{=} [
 receivedAcks\@s{8.2} {\EXCEPT} {\bang} [ n ]\@s{6.12} \.{=} \{ \} ]}%
 \@x{\@s{16.4} \.{\land}\@s{4.09} issuedWriteTS \.{'}\@s{7.82} \.{=} [
 issuedWriteTS\@s{4.1} {\EXCEPT} {\bang} [ n ] \.{=} nodeTS [ n ] ]}%
...
\@x{\@s{78.41} issuedWriteTS [ n ] . version ,\,}%
\@x{\@s{78.41} issuedWriteTS [ n ] . tieBreaker )}%
 \@x{\@s{27.72} \.{\land} nodeState [ n ] \.{\in} \{\@w{write}
 ,\,\@w{invalid\_write} ,\,\@w{replay} \}}%
 \@x{\@s{27.72} \.{\land} receivedAcks \.{'} \.{=} [ receivedAcks {\EXCEPT}
 {\bang} [ n ] \.{=}}%
\@x{\@s{187.01} receivedAcks [ n ] \.{\cup} \{ m . sender \} ]}%
...
\@x{\@s{54.63} tieBreaker\@s{4.10} \.{\mapsto} nodeTS [ n ] . tieBreaker ] )}%
 ...
 issuedWriteTS ,\,}%
\@x{\@s{89.98} aliveNodes ,\, receivedAcks {\rangle}}%
\@pvspace{8.0pt}%
\@x{ HCoordinatorActions ( n ) \.{\defeq}}%
\@x{\@s{16.4} \.{\lor} HRead ( n )}%
\@x{\@s{16.4} \.{\lor} HReplayWrite ( n )}%
\@y{\@s{0}%
 this is for failures
}%
\@xx{}%
...
\@x{\@s{115.22} nodeTS [ n ] . tieBreaker )}%
 ...
 \@x{\@s{27.72} \.{\land} {\UNCHANGED} {\langle} issuedWriteTS ,\, aliveNodes
 ,\, receivedAcks {\rangle}}%
\@pvspace{8.0pt}%
\@x{ HRcvVal ( n ) \.{\defeq}}%
\@x{\@s{16.4} \E\, m \.{\in} msgs \.{:}}%
...
\@x{\@s{78.41} nodeTS [ n ] . tieBreaker )}%
 ...
 nodeLastWriter ,\, issuedWriteTS ,\,}%
\@x{\@s{101.31} aliveNodes ,\, receivedAcks {\rangle}}%
\@pvspace{8.0pt}%
\@x{ HFollowerActions ( n ) \.{\defeq}}%
\@x{\@s{16.4} \.{\lor} HRcvInv ( n )}%
\@x{\@s{16.4} \.{\lor} HRcvVal ( n )}%
\@x{}\midbar\@xx{}%
\@x{ HNext \.{\defeq}}%
\@x{\@s{16.4} \.{\lor} \E\, n \.{\in} NODES \.{:}}%
\@x{\@s{41.12} \.{\lor} HFollowerActions ( n )}%
\@x{\@s{41.12} \.{\lor} HCoordinatorActions ( n )}%
\@x{\@s{16.4} \.{\lor} nodeFailure}%
\@y{\@s{0}%
 this is for failures
}%
\@xx{}%
...
\begin{cpar}{0}{F}{F}{0}{0}{}%
 ...
 \ensuremath{Jul} 13 15:20:40 \ensuremath{BST} 2018 by \ensuremath{akatsarakis
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{\.{\,\backslash\,}}* Created \ensuremath{Tue} \ensuremath{Jul} 10
 09:43:12 \ensuremath{BST} 2018 by \ensuremath{akatsarakis
}%
\end{cpar}%
\end{lcom}%
\end{document}
