...
\@x{}\moduleLeftDash\@xx{ {\MODULE} Hermes}\moduleRightDash\@xx{}%
\@x{ {\EXTENDS}\@s{16.4} Integers}%
\@pvspace{8.0pt}%
\@x{ {\CONSTANTS}\@s{8.2} NODES ,\,}%
\@x{\@s{62.95} MAX\_VERSION}%
\@pvspace{8.0pt}%
\@x{ {\VARIABLES}\@s{8.2} msgs ,\,}%
\@x{\@s{59.62} nodeTS ,\,}%
\@x{\@s{59.62} nodeState ,\,}%
\@x{\@s{59.62} nodeRcvedAcks ,\,}%
\@x{\@s{59.62} nodeLastWriter ,\,}%
\@x{\@s{59.62} nodeLastWriteTS ,\,}%
\@x{\@s{59.62} aliveNodes}%
\@pvspace{16.0pt}%
\@x{}%
\@y{\@s{0}%
 The consistent invariant: all alive nodes in valid state should have the
 same value / \ensuremath{TS
}}%
\@xx{}%
\@x{ HConsistent \.{\defeq}}%
 \@x{\@s{16.4} \A\, k ,\, s \.{\in} aliveNodes \.{:}\@s{4.1} \.{\lor}
 nodeState [ k ] \.{\neq}\@w{valid}}%
\@x{\@s{112.67} \.{\lor} nodeState [ s ]\@s{0.76} \.{\neq}\@w{valid}}%
\@x{\@s{112.67} \.{\lor} nodeTS [ k ] \.{=} nodeTS [ s ]}%
\@pvspace{16.0pt}%
\@x{ HMessage \.{\defeq}\@s{4.1}}%
\@y{\@s{0}%
 Messages exchanged by the Protocol
}%
\@xx{}%
 \@x{\@s{16.4} [ type \.{:} \{\@w{INV} ,\,\@w{ACK} \} ,\, sender\@s{16.11}
 \.{:} NODES ,\,}%
\@x{\@s{124.11} version\@s{13.35} \.{:} 0 \.{\dotdot} MAX\_VERSION ,\,}%
\@x{\@s{124.11} tieBreaker \.{:} NODES ]}%
\@x{\@s{31.47} \.{\cup}}%
 \@x{\@s{16.4} [ type \.{:} \{\@w{VAL} \} ,\,\@s{28.7} version\@s{13.35} \.{:}
 0 \.{\dotdot} MAX\_VERSION ,\,}%
\@x{\@s{118.36} tieBreaker \.{:} NODES ]}%
\@pvspace{8.0pt}%
\@x{ HTypeOK \.{\defeq}\@s{4.1}}%
\@y{\@s{0}%
 The type correctness invariant
}%
\@xx{}%
\@x{\@s{16.4} \.{\land}\@s{17.17} msgs\@s{41.21} \.{\subseteq} HMessage}%
\@x{\@s{16.4} \.{\land}\@s{17.17} aliveNodes\@s{16.40} \.{\subseteq} NODES}%
 \@x{\@s{16.4} \.{\land} \A\, n \.{\in} NODES \.{:} nodeRcvedAcks [ n ]
 \.{\subseteq} ( NODES \.{\,\backslash\,} \{ n \} )}%
 \@x{\@s{16.4} \.{\land}\@s{4.1} nodeLastWriter\@s{8.68} \.{\in} [ NODES
 \.{\rightarrow} NODES ]}%
 \@x{\@s{16.4} \.{\land}\@s{4.09} nodeLastWriteTS \.{\in} [ NODES
 \.{\rightarrow} [ version\@s{13.35} \.{:} 0 \.{\dotdot} MAX\_VERSION ,\,}%
\@x{\@s{179.69} tieBreaker \.{:} NODES\@s{32.8} ] ]}%
 \@x{\@s{16.4} \.{\land}\@s{4.09} nodeTS\@s{43.47} \.{\in} [ NODES
 \.{\rightarrow} [ version\@s{13.35} \.{:} 0 \.{\dotdot} MAX\_VERSION ,\,}%
\@x{\@s{179.69} tieBreaker \.{:} NODES\@s{32.8} ] ]}%
 \@x{\@s{16.4} \.{\land}\@s{4.09} nodeState\@s{34.72} \.{\in} [ NODES
 \.{\rightarrow} \{\@w{valid} ,\,\@w{invalid} ,\,\@w{invalid\_write} ,\,}%
\@x{\@s{181.91}\@w{write} ,\,\@w{replay} \} ]}%
\@pvspace{8.0pt}%
\@x{ HInit \.{\defeq}}%
\@y{\@s{0}%
...
\@xx{}%
\@x{\@s{16.4} \.{\land}\@s{4.1} msgs\@s{55.60} \.{=} \{ \}}%
\@x{\@s{16.4} \.{\land}\@s{4.09} aliveNodes\@s{30.79} \.{=} NODES}%
 \@x{\@s{16.4} \.{\land}\@s{4.09} nodeRcvedAcks\@s{11.23} \.{=} [ n \.{\in}
 NODES \.{\mapsto} \{ \} ]}%
 \@x{\@s{16.4} \.{\land}\@s{4.09} nodeState\@s{34.72} \.{=} [ n \.{\in} NODES
 \.{\mapsto}\@w{valid} ]}%
 \@x{\@s{16.4} \.{\land}\@s{4.09} nodeLastWriter\@s{8.68} \.{=} [ n \.{\in}
 NODES \.{\mapsto} {\CHOOSE} k \.{\in} NODES \.{:}}%
\@x{\@s{196.63} \A\, m \.{\in} NODES \.{:} k \.{\leq} m ]}%
 \@x{\@s{16.4} \.{\land}\@s{4.09} nodeTS\@s{43.47} \.{=} [ n \.{\in} NODES
 \.{\mapsto} [ version \.{\mapsto} 0 ,\,}%
\@x{\@s{199.41} tieBreaker \.{\mapsto}}%
\@x{\@s{203.51} {\CHOOSE} k \.{\in} NODES \.{:}}%
\@x{\@s{207.61} \A\, m \.{\in} NODES \.{:} k \.{\leq} m ] ]}%
 \@x{\@s{16.4} \.{\land}\@s{4.09} nodeLastWriteTS \.{=} [ n \.{\in} NODES
 \.{\mapsto} [ version \.{\mapsto} 0 ,\,}%
\@x{\@s{203.51} tieBreaker \.{\mapsto}}%
\@x{\@s{207.61} {\CHOOSE} k \.{\in} NODES \.{:}}%
\@x{\@s{211.71} \A\, m \.{\in} NODES \.{:} k \.{\leq} m ] ]}%
\@x{}\midbar\@xx{}%
\@x{}%
\@y{\@s{0}%
...
\@x{}%
\@y{\@s{0}%
 removed once delivered) intentionally to check protocols tolerance in
 dublicates and reorderings
}%
\@xx{}%
...
\@xx{}%
 \@x{ receivedAllAcks ( n ) \.{\defeq} nodeRcvedAcks [ n ] \.{=} NODES
 \.{\,\backslash\,} \{ n \}}%
\@pvspace{8.0pt}%
\@x{ equalTS ( v1 ,\, tb1 ,\, v2 ,\, tb2 ) \.{\defeq}\@s{4.1}}%
\@y{\@s{0}%
 Timestamp equality
}%
\@xx{}%
\@x{\@s{16.4} \.{\land}\@s{8.18} v1 \.{=} v2}%
\@x{\@s{16.4} \.{\land}\@s{8.18} tb1 \.{=} tb2}%
\@pvspace{8.0pt}%
\@x{ greaterTS ( v1 ,\, tb1 ,\, v2 ,\, tb2 ) \.{\defeq}}%
\@y{\@s{0}%
 Timestamp comparison
}%
\@xx{}%
\@x{\@s{16.4} \.{\lor} v1 \.{>} v2}%
\@x{\@s{16.4} \.{\lor} \.{\land}\@s{8.2} v1 \.{=} v2}%
\@x{\@s{27.51} \.{\land}\@s{4.1} tb1\@s{1.22} \.{>} tb2}%
\@pvspace{8.0pt}%
\@x{ isAlive ( n ) \.{\defeq} n \.{\in} aliveNodes}%
\@pvspace{8.0pt}%
\@x{ nodeFailure ( n ) \.{\defeq}}%
\@y{\@s{0}%
...
\@xx{}%
 \@x{\@s{16.4} \.{\land} \E\, k ,\, m \.{\in} aliveNodes \.{:} \.{\land}
 k\@s{3.26} \.{\neq} n}%
\@x{\@s{123.71} \.{\land} m \.{\neq} n}%
\@x{\@s{123.71} \.{\land} m \.{\neq} k}%
 \@x{\@s{16.4} \.{\land} aliveNodes \.{'} \.{=} aliveNodes \.{\,\backslash\,}
 \{ n \}}%
 \@x{\@s{16.4} \.{\land} {\UNCHANGED} {\langle} msgs ,\, nodeState ,\, nodeTS
 ,\, nodeLastWriter ,\,}%
\@x{\@s{89.98} nodeLastWriteTS ,\, nodeRcvedAcks {\rangle}}%
\@x{}\midbar\@xx{}%
\@x{ HRead ( n ) \.{\defeq}\@s{4.1}}%
\@y{\@s{0}%
 Execute a read
}%
\@xx{}%
\@x{\@s{16.4} \.{\land} nodeState [ n ] \.{=}\@w{valid}}%
 \@x{\@s{16.4} \.{\land} {\UNCHANGED} {\langle} msgs ,\, nodeTS ,\, nodeState
 ,\, nodeLastWriter ,\,}%
\@x{\@s{89.98} aliveNodes ,\, nodeLastWriteTS ,\, nodeRcvedAcks {\rangle}}%
\@pvspace{8.0pt}%
\@x{ HWrite ( n ) \.{\defeq}}%
\@y{\@s{0}%
 Execute a write
...
\@xx{}%
 \@x{\@s{16.4} \.{\land}\@s{4.1} nodeState [ n ]\@s{26.09} \.{\in}
 \{\@w{valid} ,\,\@w{invalid} \}}%
\@x{\@s{16.4} \.{\land}\@s{4.09} nodeTS [ n ] . version \.{<} MAX\_VERSION}%
 \@x{\@s{16.4} \.{\land}\@s{4.09} nodeRcvedAcks \.{'}\@s{15.33} \.{=} [
 nodeRcvedAcks\@s{8.2} {\EXCEPT} {\bang} [ n ] \.{=} \{ \} ]}%
 \@x{\@s{16.4} \.{\land}\@s{4.09} nodeLastWriter \.{'}\@s{12.78} \.{=} [
 nodeLastWriter\@s{4.1} {\EXCEPT} {\bang} [ n ]\@s{1.54} \.{=} n ]}%
 \@x{\@s{16.4} \.{\land}\@s{4.09} nodeState \.{'}\@s{38.82} \.{=} [
 nodeState\@s{24.59} {\EXCEPT} {\bang} [ n ]\@s{7.08} \.{=}\@w{write} ]}%
 \@x{\@s{16.4} \.{\land}\@s{4.09} nodeTS \.{'}\@s{47.57} \.{=} [
 nodeTS\@s{36.89} {\EXCEPT} {\bang} [ n ] . version\@s{12.29} \.{=}}%
\@x{\@s{261.35} nodeTS [ n ] . version \.{+} 1 ,\,}%
\@x{\@s{244.84} {\bang} [ n ] . tieBreaker \.{=} n ]}%
 \@x{\@s{16.4} \.{\land}\@s{4.09} nodeLastWriteTS \.{'}\@s{0.51} \.{=} [
 nodeLastWriteTS {\EXCEPT} {\bang} [ n ] . version \.{=}}%
\@x{\@s{264.34} nodeTS [ n ] . version \.{+} 1 ,\,}%
\@x{\@s{247.83} {\bang} [ n ] . tieBreaker \.{=} n ]}%
 \@x{\@s{16.4} \.{\land}\@s{4.09} send ( [ type\@s{31.39} \.{\mapsto}\@w{INV}
 ,\,}%
\@x{\@s{58.73} sender\@s{20.21} \.{\mapsto} n ,\,}%
 \@x{\@s{58.73} version\@s{17.45} \.{\mapsto} nodeTS [ n ] . version \.{+} 1
 ,\,}%
\@x{\@s{58.73} tieBreaker\@s{4.10} \.{\mapsto} n ] )}%
\@x{\@s{16.4} \.{\land}\@s{4.09} {\UNCHANGED} {\langle} aliveNodes {\rangle}}%
\@pvspace{8.0pt}%
\@x{ HReplayWrite ( n ) \.{\defeq}}%
\@y{\@s{0}%
 Execute a write-replay
}%
\@xx{}%
\@x{\@s{16.4} \.{\land}\@s{4.1} nodeState [ n ] \.{=}\@w{invalid}}%
\@x{\@s{16.4} \.{\land}\@s{4.09} {\lnot} isAlive ( nodeLastWriter [ n ] )}%
 \@x{\@s{16.4} \.{\land}\@s{4.09} nodeLastWriter \.{'}\@s{8.68} \.{=} [
 nodeLastWriter\@s{8.2} {\EXCEPT} {\bang} [ n ]\@s{4.58} \.{=} n ]}%
 \@x{\@s{16.4} \.{\land}\@s{4.09} nodeState \.{'}\@s{34.72} \.{=} [
 nodeState\@s{28.7} {\EXCEPT} {\bang} [ n ]\@s{10.12} \.{=}\@w{replay} ]}%
 \@x{\@s{16.4} \.{\land}\@s{4.09} nodeRcvedAcks \.{'}\@s{11.23} \.{=} [
 nodeRcvedAcks\@s{12.29} {\EXCEPT} {\bang} [ n ]\@s{3.03} \.{=} \{ \} ]}%
 \@x{\@s{16.4} \.{\land}\@s{4.09} nodeLastWriteTS \.{'} \.{=} [
 nodeLastWriteTS\@s{4.1} {\EXCEPT} {\bang} [ n ] \.{=} nodeTS [ n ] ]}%
 \@x{\@s{16.4} \.{\land}\@s{4.09} send ( [ type\@s{27.29} \.{\mapsto}\@w{INV}
 ,\,}%
\@x{\@s{58.73} sender\@s{16.11} \.{\mapsto} n ,\,}%
\@x{\@s{58.73} version\@s{13.35} \.{\mapsto} nodeTS [ n ] . version ,\,}%
\@x{\@s{58.73} tieBreaker \.{\mapsto} nodeTS [ n ] . tieBreaker ] )}%
 \@x{\@s{16.4} \.{\land}\@s{4.09} {\UNCHANGED} {\langle} nodeTS ,\, aliveNodes
 {\rangle}}%
\@x{}\midbar\@xx{}%
\@x{ HRcvAck ( n ) \.{\defeq}\@s{8.2}}%
\@y{\@s{0}%
 Process a received acknowledment
}%
\@xx{}%
\@x{\@s{16.4} \E\, m \.{\in} msgs \.{:}}%
\@x{\@s{27.72} \.{\land} m . type \.{=}\@w{ACK}}%
\@x{\@s{27.72} \.{\land} m . sender \.{\neq} n}%
\@x{\@s{27.72} \.{\land} m . sender \.{\notin} nodeRcvedAcks [ n ]}%
\@x{\@s{27.72} \.{\land} equalTS ( m . version ,\,}%
\@x{\@s{78.41} m . tieBreaker ,\,}%
\@x{\@s{78.41} nodeLastWriteTS [ n ] . version ,\,}%
\@x{\@s{78.41} nodeLastWriteTS [ n ] . tieBreaker )}%
 \@x{\@s{27.72} \.{\land} nodeState [ n ] \.{\in} \{\@w{write}
 ,\,\@w{invalid\_write} ,\,\@w{replay} \}}%
 \@x{\@s{27.72} \.{\land} nodeRcvedAcks \.{'} \.{=} [ nodeRcvedAcks {\EXCEPT}
 {\bang} [ n ] \.{=}}%
\@x{\@s{202.34} nodeRcvedAcks [ n ] \.{\cup} \{ m . sender \} ]}%
 \@x{\@s{27.72} \.{\land} {\UNCHANGED} {\langle} msgs ,\, nodeLastWriter ,\,
 nodeLastWriteTS ,\,}%
\@x{\@s{101.31} aliveNodes ,\, nodeTS ,\, nodeState {\rangle}}%
\@pvspace{8.0pt}%
\@x{ HSendVals ( n ) \.{\defeq}}%
\@y{\@s{0}%
 Send validations once received acknowledments from all alive nodes
}%
\@xx{}%
 \@x{\@s{16.4} \.{\land} nodeState [ n ] \.{\in} \{\@w{write} ,\,\@w{replay}
 \}}%
\@x{\@s{16.4} \.{\land} receivedAllAcks ( n )}%
 \@x{\@s{16.4} \.{\land} nodeState \.{'}\@s{32.8} \.{=} [ nodeState {\EXCEPT}
 {\bang} [ n ] \.{=}\@w{valid} ]}%
\@x{\@s{16.4} \.{\land} send ( [ type\@s{31.39} \.{\mapsto}\@w{VAL} ,\,}%
\@x{\@s{54.63} version\@s{17.45} \.{\mapsto} nodeTS [ n ] . version ,\,}%
\@x{\@s{54.63} tieBreaker\@s{4.10} \.{\mapsto} nodeTS [ n ] . tieBreaker ] )}%
 \@x{\@s{16.4} \.{\land} {\UNCHANGED} {\langle} nodeTS ,\, nodeLastWriter ,\,
 nodeLastWriteTS ,\,}%
\@x{\@s{89.98} aliveNodes ,\, nodeRcvedAcks {\rangle}}%
\@pvspace{8.0pt}%
\@x{ HCoordinatorActions ( n ) \.{\defeq}\@s{8.2}}%
\@y{\@s{0}%
 Actions of a read/write coordinator
}%
\@xx{}%
\@x{\@s{16.4} \.{\lor} HRead ( n )}%
\@x{\@s{16.4} \.{\lor} HReplayWrite ( n )}%
\@x{\@s{16.4} \.{\lor} HWrite ( n )}%
\@x{\@s{16.4} \.{\lor} HRcvAck ( n )}%
\@x{\@s{16.4} \.{\lor} HSendVals ( n )}%
\@x{}\midbar\@xx{}%
\@x{ HRcvInv ( n ) \.{\defeq}\@s{4.1}}%
\@y{\@s{0}%
 Process a received invalidation
}%
\@xx{}%
\@x{\@s{16.4} \E\, m \.{\in} msgs \.{:}}%
\@x{\@s{27.72} \.{\land} m . type \.{=}\@w{INV}}%
\@x{\@s{27.72} \.{\land} m . sender \.{\neq} n}%
\@x{\@s{27.72}}%
\@y{\@s{0}%
...
\@xx{}%
\@x{\@s{27.72} \.{\land} send ( [ type\@s{27.29} \.{\mapsto}\@w{ACK} ,\,}%
\@x{\@s{65.95} sender\@s{16.11} \.{\mapsto} n ,\,}%
\@x{\@s{65.95} version\@s{13.35} \.{\mapsto} m . version ,\,}%
\@x{\@s{65.95} tieBreaker \.{\mapsto} m . tieBreaker ] )}%
\@x{\@s{27.72} \.{\land} \.{\lor} \.{\land} greaterTS ( m . version ,\,}%
\@x{\@s{117.50} m . tieBreaker ,\,}%
\@x{\@s{117.50} nodeTS [ n ] . version ,\,}%
\@x{\@s{117.50} nodeTS [ n ] . tieBreaker )}%
 \@x{\@s{49.94} \.{\land} nodeLastWriter \.{'} \.{=} [ nodeLastWriter
 {\EXCEPT} {\bang} [ n ] \.{=} m . sender ]}%
 \@x{\@s{49.94} \.{\land} nodeTS \.{'} \.{=} [ nodeTS {\EXCEPT} {\bang} [ n ]
 . version\@s{13.35} \.{=} m . version ,\,}%
\@x{\@s{189.81} {\bang} [ n ] . tieBreaker \.{=} m . tieBreaker ]}%
 \@x{\@s{49.94} \.{\land} \.{\lor} \.{\land} nodeState [ n ] \.{\in}
 \{\@w{valid} ,\,\@w{invalid} ,\,\@w{replay} \}}%
 \@x{\@s{72.16} \.{\land} nodeState \.{'} \.{=} [ nodeState {\EXCEPT} {\bang}
 [ n ] \.{=}\@w{invalid} ]}%
 \@x{\@s{61.05} \.{\lor} \.{\land} nodeState [ n ] \.{\in} \{\@w{write}
 ,\,\@w{invalid\_write} \}}%
 \@x{\@s{72.16} \.{\land} nodeState \.{'} \.{=} [ nodeState {\EXCEPT} {\bang}
 [ n ] \.{=}\@w{invalid\_write} ]}%
\@x{\@s{38.83} \.{\lor} \.{\land} {\lnot} greaterTS ( m . version ,\,}%
\@x{\@s{115.22} m . tieBreaker ,\,}%
\@x{\@s{115.22} nodeTS [ n ] . version ,\,}%
\@x{\@s{115.22} nodeTS [ n ] . tieBreaker )}%
 \@x{\@s{49.94} \.{\land} {\UNCHANGED} {\langle} nodeState ,\, nodeTS ,\,
 nodeLastWriter {\rangle}}%
 \@x{\@s{27.72} \.{\land} {\UNCHANGED} {\langle} nodeLastWriteTS ,\,
 aliveNodes ,\, nodeRcvedAcks {\rangle}}%
\@pvspace{8.0pt}%
\@x{ HRcvVal ( n ) \.{\defeq}\@s{8.2}}%
\@y{\@s{0}%
 Process a received validation
}%
\@xx{}%
\@x{\@s{16.4} \E\, m \.{\in} msgs \.{:}}%
\@x{\@s{27.72} \.{\land} nodeState [ n ] \.{\neq}\@w{valid}}%
\@x{\@s{27.72} \.{\land} m . type \.{=}\@w{VAL}}%
\@x{\@s{27.72} \.{\land} equalTS ( m . version ,\,}%
\@x{\@s{78.41} m . tieBreaker ,\,}%
\@x{\@s{78.41} nodeTS [ n ] . version ,\,}%
\@x{\@s{78.41} nodeTS [ n ] . tieBreaker )}%
 \@x{\@s{27.72} \.{\land} nodeState \.{'} \.{=} [ nodeState {\EXCEPT} {\bang}
 [ n ] \.{=}\@w{valid} ]}%
 \@x{\@s{27.72} \.{\land} {\UNCHANGED} {\langle} msgs ,\, nodeTS ,\,
 nodeLastWriter ,\, nodeLastWriteTS ,\,}%
\@x{\@s{101.31} aliveNodes ,\, nodeRcvedAcks {\rangle}}%
\@pvspace{8.0pt}%
\@x{ HFollowerActions ( n ) \.{\defeq}\@s{4.1}}%
\@y{\@s{0}%
 Actions of a write follower
}%
\@xx{}%
\@x{\@s{16.4} \.{\lor} HRcvInv ( n )}%
\@x{\@s{16.4} \.{\lor} HRcvVal ( n )}%
\@x{}\midbar\@xx{}%
\@x{ HNext \.{\defeq}}%
\@y{\@s{0}%
 Modeling \ensuremath{Hermes} protocol (Coordinator and Follower actions
 while emulating failures)
}%
\@xx{}%
\@x{\@s{16.4} \E\, n \.{\in} aliveNodes \.{:}}%
\@x{\@s{42.31} \.{\lor} HFollowerActions ( n )}%
\@x{\@s{42.31} \.{\lor} HCoordinatorActions ( n )}%
\@x{\@s{42.31} \.{\lor} nodeFailure ( n )}%
\@y{\@s{0}%
 emulate node failures
}%
\@xx{}%
\@x{}\bottombar\@xx{}%
\end{document}
